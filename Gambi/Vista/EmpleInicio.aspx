<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/MPE.master" AutoEventWireup="true" CodeFile="~/Controller/EmpleInicio.aspx.cs" Inherits="Vista_EmpleInicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="w-100">
        ...
        <tr>
            <td>&nbsp;</td>
            <td>
                <asp:GridView ID="GV_IP" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Doc_identidad" SelectMethod="GV_IP_GetData" UpdateMethod="GV_IP_UpdateItem" ForeColor="Black" GridLines="Vertical" HorizontalAlign="Center" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px">
