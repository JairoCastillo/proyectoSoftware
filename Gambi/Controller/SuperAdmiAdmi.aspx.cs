...
public partial class Vista_SuperAdmiAdmi : System.Web.UI.Page
{
    ...
    protected void GV_AS_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        GridViewRow row = GV_AS.Rows[e.RowIndex];
    ...
    protected void GV_AS_RowDataBound(object sender, GridViewRowEventArgs e)
    {
